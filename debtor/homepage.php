...
<body>
    <section class="showcase">
      ...
      <section id="about">
        ...
        <br>
        <button type="submit" class="button5" onclick="payCheq()">Calculate</button>
  <script>
      var num = document.getElementById("offRequest").value;
function payCheq() {
    var tot=num/12*.12
   return window.alert("You would Pay N$"+ tot + " Per Month For a Period of One Year")
}
  </script>
        <div class="social">
