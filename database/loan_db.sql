...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2021 at 04:21 PM
...
INSERT INTO `borrowers` (`id`, `firstname`, `middlename`, `lastname`, `contact_no`, `address`, `email`, `student_number`, `date_created`, `Password`, `Username`, `dob`) VALUES
(0, 'Domingos', 'Alberto Policarpo De', 'Sousa', '+264857012971', 'windhoek north', 'maurodesousa94@gmail.com', '18007438', '0000-00-00', '698d51a19d8a121ce581499d7b701668', 'maurosousa94', '2021-09-30'),
(1, 'John', 'C', 'Smith', '+16554 454654', 'Sample address', 'jsmith@sample.com', '789845-23', '0000-00-00', '123', 'john', '0000-00-00');
...
(3, '81409630', 1, 1, 'Sample Only', 100000, 1, 1, '2020-09-26 09:06:00', '2021-10-19 00:43:45'),
(4, '82865836', 0, 0, '', 56464, 2, 0, '0000-00-00 00:00:00', '2021-10-19 04:15:39');
...
CREATE TABLE `users` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT 2 COMMENT '1=admin , 2 = staff, 3=debtor'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
